...
%description -l pl
libcfg+ to biblioteka w C do analizy linii poleceñ i plików
konfiguracyjnych. Mo¿na ustawiaæ ró¿ne specjalne w³asno¶ci, takie jak
znaki cytowania, ³añcuch ograniczaj±ce, prefiksy komentarzy w plikach,
wieloliniowe postfiksy i inne. Biblioteka obs³uguje wiele typów
danych, takich jak logiczne, liczby ca³kowite, liczby dziesiêtne,
³añcuchy z wieloma dodatkowymi flagami typów (takimi jak wiele
warto¶ci dla jednej opcji).

%package devel
Summary:	Header files for libcfg+ library
Summary(pl):	Pliki nag³ówkowe biblioteki libcfg+
...
Pliki nag³ówkowe biblioteki libcfg+.
